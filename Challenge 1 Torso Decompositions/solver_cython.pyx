...
# This function will be called once per worker to set the globals
def init_worker_cython(int n_val, np.ndarray[UINT64_t, ndim=1] adj_bits_val):
    global N, ADJ_BITS
    N = n_val
    ADJ_BITS = adj_bits_val

# C-level bitcount function for maximum speed
...
# This is the C-level compiled evaluator. It will be extremely fast.
