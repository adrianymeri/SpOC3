...
large-graph entry exploited this planted structure. The *construction itself*
is confirmed directly by the competition organisers (Bannach et al. 2024;
M. Bannach, personal communication, July 2026): the instances were built as
the disjoint union of several low-treewidth graphs glued together with a dense
graph, deliberately so that "a decent torso can be recovered." This is exactly
the structure recovered here from the instances alone — the low-treewidth
components form the recoverable low/mid-width torso, and the dense gluing graph
is the width-499 core proved optimal in §10.5/§13, whose true-twin classes are
dissected above. The structural analysis of §14.2–14.3 therefore independently
reverse-engineers the intended generative process, rather than merely observing
...
- Bannach, M., Blazquez, E., Izzo, D., Acciarini, G., Hadjiivanov, A., Heißel, G.,
  Mastroianni, R., Origer, S., Grover, J., Dold, D., & Rudge, Z. (2024). The Space
  Optimization Competition: Third Edition. In *Proceedings of the Genetic and
  Evolutionary Computation Conference Companion (GECCO '24 Companion)*, Melbourne,
  Australia. ACM. https://doi.org/10.1145/3638530.3664048 (Official competition
  reference.)
- Bannach, M. (2026). Personal communication, July 2026. (Instance construction:
  disjoint union of low-treewidth graphs glued with a dense graph to guarantee a
  recoverable torso, confirming §14.2.)
