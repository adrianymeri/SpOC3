...
caffeinate -i nohup python3 tools/gbfcpp.py --problem large-graph --algo gbfcpp_slack --cap20 --only-widths $W --rounds 1000 --round-budget 120 > large_gbfcpp_slack2.log 2>&1 &
