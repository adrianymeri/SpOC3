...
pkill -f gbfcpp.py 2>/dev/null; pkill -f boundary_lns.py 2>/dev/null
pkill -f cqs.py 2>/dev/null; pkill -f quotient_lns.py 2>/dev/null
pkill -f bandit_widths.py 2>/dev/null; sleep 2
...
caffeinate -i nohup python3 -u tools/cqs.py --width sweep --iters 500000000 --seed $RANDOM > cqs.log 2>&1 &
caffeinate -i nohup python3 -u tools/quotient_lns.py --iters 500000000 --seed $RANDOM > quotient_lns.log 2>&1 &
caffeinate -i nohup python3 -u tools/bandit_widths.py --problem medium-graph --stint 1800 > bandit_medium.log 2>&1 &
